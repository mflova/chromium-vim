...
Mappings.defaults = [
  ...
  ['.',         'repeatCommand'],
  ['<C-z>',     'lastClosedTab'],
  ['wj',        ':open https://flyability.atlassian.net/jira/software/c/projects/GEU/boards/99<CR>'],
  ['wg',        ':open https://gmail.com<CR>'],
  ['wd',        ':open https://drive.com<CR>'],
  ['wc',        ':open https://calendar.google.com<CR>'],
  ['wh',        ':open https://app.holaspirit.com/auth<CR>'],
  ['wo',        ':open https://flyability.odoocloud.ch/web#home<CR>'],
  ['wb',        ':open https://bitbucket.org/dashboard/overview<CR>'],
  ['wre',       ':open https://bitbucket.org/Flyability/eliospy/src/develop/<CR>'],
  ['wrv',       ':open https://bitbucket.org/Flyability/gaston_validation_tests/src/develop/<CR>'],
  ['wrb',       ':open https://bitbucket.org/Flyability/build_gaston/src/develop/<CR>'],
  ['wrr',       ':open https://bitbucket.org/Flyability/rovio/src/develop/<CR>'],
  ['wrg',       ':open https://bitbucket.org/Flyability/gastonpy/src/develop/<CR>'],
  ['wJ',        ':tabnew https://flyability.atlassian.net/jira/software/c/projects/GEU/boards/99<CR>'],
  ['wtg',        ':tabnew https://gmail.com<CR>'],
  ['wtd',        ':tabnew https://drive.com<CR>'],
  ['wtc',        ':tabnew https://calendar.google.com<CR>'],
  ['wth',        ':tabnew https://app.holaspirit.com/auth<CR>'],
  ['wto',        ':tabnew https://flyability.odoocloud.ch/web#home<CR>'],
  ['wtb',        ':tabnew https://bitbucket.org/dashboard/overview<CR>'],
  ['wtre',       ':tabnew https://bitbucket.org/Flyability/eliospy/src/develop/<CR>'],
  ['wtrv',       ':tabnew https://bitbucket.org/Flyability/gaston_validation_tests/src/develop/<CR>'],
  ['wtrb',       ':tabnew https://bitbucket.org/Flyability/build_gaston/src/develop/<CR>'],
  ['wtrr',       ':tabnew https://bitbucket.org/Flyability/rovio/src/develop/<CR>'],
  ['wtrg',       ':tabnew https://bitbucket.org/Flyability/gastonpy/src/develop/<CR>'],
];
